...
def main():
    ...
    with tab3:
        ...
        <div class="info-box">
            ...
            <p style="color: #e2e8f0;">
                This system uses the Ollama AI API with the DeepSeek V4 Pro model to understand your 
    ...
    with tab4:
        ...
        <div class="info-box">
            ...
            <p style="color: #e2e8f0;">
                <strong>API Endpoint:</strong> <code>{API_CONFIG.base_url}</code><br>
            ...
            <ol style="color: #cbd5e1;">
                <li>Get your API key from Ollama</li>
